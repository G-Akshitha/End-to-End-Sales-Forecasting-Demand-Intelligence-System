...
# ============================================================
    ...
    monthly_subcat = (df.groupby(["Sub-Category",pd.Grouper(key="Order Date",freq=MONTH_END)])["Sales"].sum().reset_index())
    ...
    subcat_features["Demand Cluster"] = (subcat_features["Cluster"].map(cluster_labels))
